...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <h4 class="mb-3">Nueva Línea Telefónica</h4>
            <form action="{{ route('lineas_telefonicas.store') }}" method="POST">
                @csrf

                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label for="linea" class="form-label">Número de Línea:</label>
                        <input type="text" name="linea" id="linea" class="form-control" value="{{ old('linea') }}" required>
                    </div>
                    <div class="col-md-6 mb-3">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="id_emisor" id="id_emisor" class="form-control">
                            ...
                            @foreach ($emisores as $emisor)
                                <option value="{{ $emisor->id }}" {{ old('id_emisor') == $emisor->id ? 'selected' : '' }}>
                                    {{ $emisor->nombre }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" id="ccosto_display" class="form-control" placeholder="Se completa al elegir Empresa + Ubicación" readonly>
                        <input type="hidden" name="id_centro_costo" id="id_centro_costo" value="{{ old('id_centro_costo') }}">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select name="id_aparato" id="id_aparato" class="form-control">
                        ...
                        @foreach ($aparatos as $aparato)
                            <option value="{{ $aparato->id }}" {{ old('id_aparato') == $aparato->id ? 'selected' : '' }}>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="imei_equipo" id="imei_equipo" class="form-control" value="{{ old('imei_equipo') }}">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="imei_sim" class="form-label">IMEI SIM:</label>
                        <input type="text" name="imei_sim" id="imei_sim" class="form-control" value="{{ old('imei_sim') }}">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" name="fecha_entrega_sim" id="fecha_entrega_sim" class="form-control" value="{{ old('fecha_entrega_sim') }}">
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="fecha_renovacion_equipo" class="form-label">Fecha Renovación Equipo:</label>
                        <input type="date" name="fecha_renovacion_equipo" id="fecha_renovacion_equipo" class="form-control" value="{{ old('fecha_renovacion_equipo') }}">
                    </div>
                </div>
