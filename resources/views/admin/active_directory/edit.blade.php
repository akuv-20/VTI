...
<div class="container-fluid vti-page">
    ...
    <div class="vti-page-header">
        <h4><i class="bi bi-person-gear me-2"></i>Editar usuario AD
    ...
    <div class="col-xl-7 col-lg-9">
        ...
        <div class="card border-0 shadow-sm mb-3">
            <div class="card-body p-4">
                ...
                <form action="{{ route('admin.active_directory.update', $sam) }}" method="POST">
                    @csrf @method('PUT')
        ...
        <div class="card border-0 shadow-sm border-warning-subtle">
            <div class="card-body p-4">
                ...
                <form action="{{ route('admin.active_directory.reset-password', $sam) }}" method="POST">
                    @csrf
