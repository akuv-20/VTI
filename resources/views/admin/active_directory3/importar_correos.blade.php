...
<div class="container vti-page">
    ...
    <div class="vti-page-header">
        <h4><i class="bi bi-envelope-arrow-up me-2" style="color:#6366f1"></i>Importar correos — Unifrutti</h4>
        <a href="{{ route('admin.active_directory3.index') }}" class="btn btn-outline-secondary btn-sm">
        ...
        <div class="col-lg-7">
            ...
            <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="card-body py-3">
                    ...
                    <div class="alert alert-info py-2 mb-0 small">
                        ...
                        El sistema busca cada usuario por el atributo <code>mail</code> del AD de Unifrutti.
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4">
                    <form method="POST"
                          action="{{ route('admin.active_directory3.procesar_importacion') }}"
    ...
    <div class="alert alert-success d-flex align-items-center gap-2 py-2 mb-3">
        ...
        <span>Se actualizó el correo de <strong>{{ $actualizados }}</strong> {{ $actualizados === 1 ? 'usuario' : 'usuarios' }} en Active Directory (Unifrutti).</span>
    </div>
    @endif
