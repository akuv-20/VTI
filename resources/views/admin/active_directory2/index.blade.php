...
<div class="container-fluid vti-page">
    ...
    <div class="vti-page-header">
        <h4><i class="bi bi-diagram-3 me-2"></i>Active Directory — Grupo Verfrut (Perú)
            @if(isset($total) && $total > 0)
                <span class="badge bg-secondary fw-normal ms-1" style="font-size:.7rem">{{ $total }}</span>
            @endif
        </h4>
        <a href="{{ route('admin.active_directory2.importar_correos') }}" class="btn btn-outline-primary btn-sm">
    ...
    @if(isset($ldapError))
        <div class="alert alert-danger d-flex align-items-start gap-2">
            ...
            <div>
                <strong>No se pudo conectar al AD (Grupo Verfrut Perú):</strong> {{ $ldapError }}<br>
                <a href="{{ route('admin.configuracion.index') }}#pane-ldap2" class="alert-link">
                    Ir a Configuración → AD Grupo Verfrut (Perú)
                </a>
            </div>
        </div>
    @else
        ...
        {{-- Filtros --}}
        <form method="GET" action="{{ route('admin.active_directory2.index') }}" class="mb-3">
                ...
                <div class="col">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" name="buscar" class="form-control"
                               ...
                               autofocus>
                        @if($buscar)
                            <a href="{{ route('admin.active_directory2.index') }}" class="btn btn-outline-secondary">
                                <i class="bi bi-x"></i>
                            </a>
                        @endif
                    </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0" style="font-size:.875rem">
                    ...
                    <tbody>
                        ...
                        @endphp
                        <tr class="ad2-fila-click" data-href="{{ route('admin.active_directory2.edit', $sam) }}"
                            ...
                            <td class="text-end">
                                <div class="d-flex gap-1 justify-content-end">
                                    <a href="{{ route('admin.active_directory2.edit', $sam) }}"
