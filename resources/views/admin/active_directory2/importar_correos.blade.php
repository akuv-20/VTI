...
<div class="container vti-page">
    ...
    <div class="vti-page-header">
        <h4><i class="bi bi-envelope-arrow-up me-2" style="color:#6366f1"></i>Importar correos — Grupo Verfrut (Perú)</h4>
        <a href="{{ route('admin.active_directory2.index') }}" class="btn btn-outline-secondary btn-sm">
        ...
        <div class="col-lg-7">
                ...
                <div class="card-body py-3">
                    ...
                    <div class="table-responsive mb-3">
                        <table class="table table-sm table-bordered mb-0" style="font-size:.84rem">
                            ...
                            <tbody>
                                <tr>
                                    <td class="font-monospace text-muted">jperez@grupoVerfrut.pe</td>
                    ...
                    <div class="alert alert-info py-2 mb-0 small">
                        ...
                        El sistema busca cada usuario por el atributo <code>mail</code> del AD de Grupo Verfrut (Perú).
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4">
                    <form method="POST"
                          action="{{ route('admin.active_directory2.procesar_importacion') }}"
        ...
        <div class="col-6 col-md-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body text-center py-3">
                    ...
                    <div class="small text-muted mt-1"><i class="bi bi-check-circle-fill text-success me-1"></i>Actualizados</div>
                </div>
            </div>
        </div>
        <div class="col-6 col-md-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body text-center py-3">
                    ...
                    <div class="small text-muted mt-1"><i class="bi bi-question-circle-fill text-secondary me-1"></i>No encontrados</div>
                </div>
            </div>
        </div>
        <div class="col-6 col-md-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body text-center py-3">
                    ...
                    <div class="small text-muted mt-1"><i class="bi bi-dash-circle-fill text-warning me-1"></i>Sin cambio</div>
                </div>
            </div>
        </div>
        <div class="col-6 col-md-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body text-center py-3">
                    ...
                    <div class="small text-muted mt-1"><i class="bi bi-x-circle-fill text-danger me-1"></i>Errores</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="alert alert-success d-flex align-items-center gap-2 py-2 mb-3">
        ...
        <span>Se actualizó el correo de <strong>{{ $actualizados }}</strong> {{ $actualizados === 1 ? 'usuario' : 'usuarios' }} en Active Directory (Grupo Verfrut Perú).</span>
    </div>
    @endif
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @elseif($r['estado'] === 'error')
                                ...
                                @if($r['mensaje'])
                                    <small class="text-danger ms-1" style="font-size:.78rem">{{ $r['mensaje'] }}</small>
                                @endif
                            @endif
                        </td>
                    </tr>
