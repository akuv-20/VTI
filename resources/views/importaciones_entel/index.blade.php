...
<div class="container-fluid vti-page">
    ...
    <div class="vti-page-header">
        <div class="d-flex align-items-center gap-3">
            <h4>Importaciones Entel</h4>
            <span class="text-muted small">
                <span class="badge bg-primary me-1">1.17882753</span>Líneas Móviles
            </span>
            <span class="text-muted small">
                <span class="badge bg-warning text-dark me-1">1.10290392</span>BAM
            </span>
        </div>
        <a href="{{ route('importaciones_entel.create') }}" class="btn btn-success btn-sm">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="vti-actions">
                                <a href="{{ route('importaciones_entel.show', $imp) }}" class="vti-btn-view" title="Ver detalle">
                                    <i class="bi bi-eye-fill"></i>
                                </a>
                                <form action="{{ route('importaciones_entel.destroy', $imp) }}" method="POST"
