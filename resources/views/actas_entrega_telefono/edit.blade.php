...
<div class="container-fluid vti-page">
    ...
    <div class="vti-page-header">
        <h4><i class="bi bi-pencil-square me-2"></i>Editar Acta de Entrega — Teléfono</h4>
        <a href="{{ route('actas_entrega_telefono.index') }}" class="btn btn-outline-secondary btn-sm">
    ...
    <form method="POST" action="{{ route('actas_entrega_telefono.update', $acta) }}" style="max-width:900px">
        @csrf @method('PUT')
        ...
        <div class="d-flex gap-2">
            ...
            <a href="{{ route('actas_entrega_telefono.imprimir', $acta) }}" target="_blank" class="btn btn-outline-primary">
                <i class="bi bi-printer-fill me-1"></i>Reimprimir
            </a>
            <a href="{{ route('actas_entrega_telefono.index') }}" class="btn btn-outline-secondary">Cancelar</a>
        </div>
    </form>
