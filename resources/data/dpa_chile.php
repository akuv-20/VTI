...
/**
 * División político-administrativa de Chile: 16 regiones y 346 comunas.
 *
 * Se sirve como API interna (admin.sitios.dpa) para alimentar los selectores
 * de región y comuna de la ficha de sitio. Los datos cambian muy de vez en
 * cuando (la última región nueva fue Ñuble, en 2018), así que viven aquí en
 * vez de depender de un servicio externo que puede no estar disponible desde
 * la red interna.
 */
return [
    ...
    'Valparaíso' => [
        'Algarrobo', 'Cabildo', 'Calle Larga', 'Cartagena', 'Casablanca', 'Catemu',
        'Concón', 'El Quisco', 'El Tabo', 'Hijuelas', 'Isla de Pascua', 'Juan Fernández',
        'La Calera', 'La Cruz', 'La Ligua', 'Limache', 'Llaillay', 'Los Andes',
